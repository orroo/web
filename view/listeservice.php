...
<a href="http://localhost/P - Copy/view/selectservice.html"><button class="links">Return</button></a>
...
<table border="2">
    ...
    <tr>
            ...
            <td>
                <form method="POST" action="http://localhost/P - Copy/view/updateservice.php">
                    <input class="update" type="submit" name="update" value="Update">
                    <input type="hidden" value=<?PHP echo $service['id']; ?> name="id">
                </form>
            </td>
            <td>
                <a href="http://localhost/P - Copy/view/deleteser.php?id=<?php echo $service['id']?>"> <button class="delete">Delete</button></a>
            </td>
    </tr>
